  ...
  <div id="mainSlide" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner">
      <div class="carousel-item active bg_image" id="bg_image">
          <span class="bg_text">{{__('Gülümsemelerinizi beyaz ve sağlıklı dişler takip etsin!')}}</span>
      </div>
      <div class="carousel-item bg-image-1" id="bg_image1">
          <span class="bg_text" id="bg_text1">{{__('İçiniz mutluyken dışınız buna rahatlıkla eşlik edebilsin!')}}</span>
      </div>
    </div>
  ...
  <div class="container marketing">
    ...
    <div class="row">
      <div class="col-lg-4">
        ...
        <h2>{{__('Diş Ağrıları')}}</h2>
        <p>{{__('Diş ağrılarınızı geçirici tedaviyi anında uygulamanın yanı sıra dişte düzenli tedavi gerektiren bir kusur varsa bunun tespitini yapıyoruz.')}}</p>
      ...
      <div class="col-lg-4">
        ...
        <h2>{{__('İmplant')}}</h2>
        <p>{{__('Yapay diş alanında son yılların en etkili tedavisi sayılabilecek implant tedavisi bu konuda uzmanlaşmış doktorlarımızca yapılıyor.')}}</p>
        <p><a class="btn btn-secondary" href="#" role="button">Detayları gör &raquo;</a></p>
      </div><!-- /.col-lg-4 -->
      <div class="col-lg-4">
        <img src="{{ asset('/dist/img/cleanTeeth.svg') }}" class="bd-placeholder-img rounded-circle" width="140" height="140" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid slice" focusable="false" role="img" aria-label="Placeholder: 140x140"><title>Placeholder</title><rect width="100%" height="100%" fill="#777"/><text x="50%" y="50%" fill="#777" dy=".3em"></text></img>
        <h2>{{__('Diş Bakımı')}}</h2>
        <p>{{__('Düzenli bir diş bakımı ile yaşayabileceğiniz diş ağrısı ve kusurlarını minimuma indirmeye çalışıyoruz.')}}</p>
        <p><a class="btn btn-secondary" href="#" role="button">{{__('Detayları gör')}} &raquo;</a></p>
      </div><!-- /.col-lg-4 -->
    </div><!-- /.row -->
    ...
    <div class="row featurette">
      <div class="col-md-7">
        <h2 class="featurette-heading">{{__('Dent Cappadocia merkez konumuyla sizleri bekliyor.')}}</h2>
        <p class="lead">{{__('İster özel aracınızla ister toplu taşıma araçlarıyla rahatlıkla ulaşabileceğiniz Dent Cappadocia şehrin merkezinde adeta ışıldıyor.')}}</p>
      </div>
      <div class="col-md-5">
    ...
    <div class="row featurette">
      <div class="col-md-7 order-md-2">
        <h2 class="featurette-heading">{{__('Son Teknoloji Tedavi')}}</h2>
        <p class="lead">{{__('Teknoloji ve tıppın birbirinin ayrılmaz bir parçası olduğu olgusundan hareketle, tedavilerde verimliliği ve konforu son teknoloji ekipmanlarımızla sağlıyoruz.')}}</p>
      </div>
    ...
    <div class="row featurette">
      <div class="col-md-7">
        <h2 class="featurette-heading">{{__('Ve Sizleri Bekliyoruz!')}}</h2>
        <p class="lead">{{__('Kararınızı bizden yana kullandıysanız tek yapmanız gereken aşağıda yer alan Randevu Ayarla butonuna tıklamak. Şimdiden geçmiş olsun dileklerimizi sunarız.')}}</p>
      </div>
      <div class="col-md-5">
